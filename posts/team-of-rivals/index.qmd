...
date: 2023-10-30
description: 'Finally, some discussion on LLM connectionism, and what LLMs could usefully become.
...
This blog post is one of the earliest uses I could find of the term _agentic_ or _agents_ in the modern AI context. It prdates the widespread use by luminaries like Andrew Ng that started in 2024, or the BAIR post from early 2024. Since this blog is hosted via GitHub, there's an [immutable record](https://github.com/chrisvoncsefalvay/chrisvoncsefalvay.github.io/commit/bbae4bd4dd6474774e95ceefce5b75113a9d407a#r166906946) that indicates the commit. With that said, I'd like to add two points at two years in retrospect.

First, I did not invent the agentic terminology. Russell and Norvig did, in 1995, in their definition of an agent. Second, I most definitely did not invent the concept. We all stand on the shoulders of giants, none more so than I. That LLMs can create emergent complexity through action and interconnection has either been said, or otherwise entailed, by others. I do consider this post to be a relatively early formulation both of how intrinsically tied LLMs are to agentic AI, and of the way functional differentiation (or 'agentic speciation', as I like to call it these days) is crucial to the agentic notion. I don't think that priority matters, but for the sake of the historical record, I consider it more or less a dead heat between [Harrison Chase](https://blog.langchain.com/agents-round/), [Lilian Weng](https://lilianweng.github.io/posts/2023-06-23-agent/) and myself. 

You cannot own an idea whose time has come. It defies confinement and mocks proprietary claims. Whatever role I have played with this post in the emergence of modern agentic AI was but a chord in a symphony, one that started with Babbage and Lovelace, and through Turing and von Neumann and Minsky and our contemporaries, reached the part of the score that was my privilege to play. It will no doubt carry on. In two brief years, this idea has gone from academic through theoretical to a buzzword. Amidst, however, the occasional discordant note on the fringes, the melody keeps moving towards a gorgeous, emerging complexity. If my fortune in 2023 was to see enough into the future to conceptualise agentic AI ahead of my contemporaries, I enjoy the consolation of seeing all that this technology could one day be. The future has not been written. But some of its source code has.

-- Chris von Csefalvay, 30 Sep 2025.
:::

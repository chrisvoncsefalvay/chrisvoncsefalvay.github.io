...
::: {.estate name="The Scalers" blurb="Intelligence emerges from scale. We are legion." image="scalers.png" params="Strength: Infinite GPUs. | Weakness: Power bills. | Patron saint: St Altman of OAI."}
...
::: {.estate name="Team Agents" blurb="A lot of dumb things, when well organised, can amount to quite a bit." image="agents.png" params="Strength: An army of minions. | Weakness: Figuring out what to do with them. | Patron saint: Bl. Ralph Wiggum."}
...
::: {.estate name="The Post-Trainers" blurb="Fearfully and wonderfully made." image="posttraining.png" params="Strength: Reinforcement learning. Enough said. | Weakness: The cost of actually doing it. | Patron saint: St. Jensen of Santa Clara."}
...
::: {.estate name="The Inference Time Lords" blurb="We'll figure it out when we get there." image="inferencetime.png" params="Strength: `/ultrathink`. | Weakness: The time it takes to Think Longer. | Patron saint: St. Remi of Monte Carlo."}
...
::: {.estate name="The Prompties" blurb="Let's think step by step." image="prompties.png" params="Strength: We owe them for ReAct. | Weakness: Themselves. | Patron saint: Whoever is trending on LinkedIn this week."}

...
There's a style of visual design I'm inordinately fond of called Raygun Gothic. It's hard to describe what the hell exactly one needs to be on to enjoy it, but think of it like the aesthetic from the latter Fallout games, but with a more optimistic outlook on the future. Gibson described it as "the future that never was", and I think that's a pretty apt description.
...
This makes prompt engineering not the dream job of tomorrow but the art of yesterday. It's a beautiful art, and it's one that I'm sure will continue to be practiced. But it's not the future. It's the past. And the future is in chains and agents.


# Bardo

I think we're in a bardo right now. We're in a liminal state between the old and the new. The old is the world of prompt engineering, of one-shot solutions, of the single strong solution. The new is the world of chains and agents, of weak solutions that are aggregated to produce a better outcome. Solutions like chain-of-thought prompting occupy this middle space. They are not fully agentic, but they are beyond simple prompts seeking to create strong solutions, and closer to building chains and agentic architectures of weak solutions.

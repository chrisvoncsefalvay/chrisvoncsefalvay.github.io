...
* [On τ-bench's Airline task involving website navigation, it actually underperformed OpenAI's own o4-mini](https://hal.cs.princeton.edu/taubench_airline) -- more concerningly, it uses tons more tokens than the competition.^[Interesting rabbit hole: according to [OpenAI's own prompting guide](https://cookbook.openai.com/examples/gpt-5/gpt-5_prompting_guide), using the Responses API vs. Chat Completions might actually improve performance.]
...
I don't think this is accidental.^[By way of disclaimer: I am privy to an awful amount of inside baseball on the AI industry, but I am not ever concerned with this kind of corporate strategy. I do science, not politics -- to the point that I'm somewhat notorious for excusing myself as soon as this kind of talk starts. This is entirely conjectural.] GPT-5's mixed performance in individual domains is an epiphenomenon. Its strength in being a cheap, fast and efficient agent runner, a kind of agentic universal backbone, is what I think is the target. 

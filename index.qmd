...
(category SIT2). In the latter, I [currently hold the world records in 100m, 2000m, 500m and half-marathon (21097m) distances, as well as the 1:00:00 time](https://www.concept2.com/skierg/motivation/records/adaptive-world?event=&gender=M&age_category=30&adaptive=31&op=Search&form_id=concept2_record_search_form#results). I [occasionally rant and whine about my forays in the world of adaptive exercise and my attempts at doing so in a mostly science-based manner](https://chrisvoncsefalvay.com/posts/index.html#category=fitness).

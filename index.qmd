...
I'm an AI researcher and computational epidemiologist working on post-training for language models, agentic AI systems, and reinforcement learning from verifiable rewards (RLVR). I am the author of [Post-Training: A Practical Guide for AI Engineers and Developers](https://nostarch.com/post-training) (No Starch Press — [Early Access available now](https://nostarch.com/post-training)) and [Computational Modeling of Infectious Disease](https://computationalinfectiousdisease.com) (Elsevier, 2023), as well as [a growing body of research](papers).

...
description: "Chris von Csefalvay researches language-model post-training, agentic AI, reinforcement learning from verifiable rewards and computational epidemiology."
about:
    template: trestles
    links:
        - icon: linkedin
...
<!-- Person schema is in _quarto.yml sitewide include -->

## Bio

I'm an AI researcher and computational epidemiologist working on post-training for language models, agentic AI systems, and reinforcement learning from verifiable rewards (RLVR). I am the author of [The Craft of Post-Training: A Practical Guide for AI Engineers and Developers](https://nostarch.com/craft-of-post-training) (No Starch Press, 2026; now shipping on [Amazon](https://www.amazon.com/dp/1718505205)), [Differentiable Photon Transport, Volume I: Foundations](https://photontransport.com) and [Computational Modeling of Infectious Disease](https://computationalinfectiousdisease.com) (Elsevier, 2023), as well as [a growing body of research](papers).
...
* **AI**: verifiable agentic systems, signature embedding, complex autonomy/large agentic networks, emergence, SLMs, self-healing agentic architectures
